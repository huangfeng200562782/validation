                        ...
                        <div id="login" class="animate form">
                            <form  action="${basePath }signin.action" autocomplete="on" method="post"> 
                                ...
                                <p> 
                                    ...
                                    <input id="username" name="username" required="required" type="text" placeholder="eg:root" style="font-size:14px;"/>
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> 你的密码 </label>
                                    <input id="password" name="userpass" required="required" type="password" placeholder="eg:123456" style="font-size:14px;"/> 
                                </p>
                                <p class="keeplogin"> 
